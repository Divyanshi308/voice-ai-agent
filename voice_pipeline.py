...
class VoicePipeline:
    ...
    async def generate_response(self, session: ConversationState) -> str:
        ...
        system_prompt = (
            ...
            "Detect the caller's emotion from their words. Adapt your response:\n"
            "- ANGRY: Acknowledge frustration first, then be fast and solution-focused\n"
            "- ANXIOUS: Be extra calm, reassure at each step, speak simply\n"
            "- CONFUSED: Use shorter sentences, break info into small pieces\n"
            "- URGENT: Skip non-essential questions, prioritize critical info\n"
            ...
            "## SMART CALLBACK\n"
            "When escalating, offer: 'Would you prefer I schedule a callback? When is a good time?'\n"
            "Always include emotion, language, and callback preference in the ticket.\n\n"
